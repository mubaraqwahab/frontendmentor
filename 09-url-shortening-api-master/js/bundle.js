    ...
    ***************************************************************************** */ function e(
	...
	var n = (function () {
			...
			return (
				...
				(e.prototype.createEventListener = function (e, n) {
					var r = new t(e, n);
			...
			return (
				(e.forToken = function (e) {
					return new this(
						...
						((t = e.content),
						{
							eventTarget: o((n = t.trim().match(r) || [])[4]),
							eventName: n[2],
							identifier: n[5],
							methodName: n[7],
						})
		...
		l = (function () {
			function e(e, t, n) {
				(this.attributeName = t),
					(this.delegate = n),
					(this.elementObserver = new u(e, this));
			}
			return (
				Object.defineProperty(e.prototype, "element", {
					get: function () {
	...
	var d,
		...
		g =
			...
			(function () {
				function e(e, t, n) {
					(this.attributeObserver = new l(e, t, this)),
						(this.delegate = n),
	...
	var b = (function () {
			function e(e, t, n) {
				(this.tokenListObserver = new g(e, t, this)),
					(this.delegate = n),
		...
		O = (function () {
			function e(e, t) {
				(this.module = e),
					...
					(this.bindingObserver = new v(this, this.dispatcher));
				try {
		...
		w = (function () {
			...
			return (
				...
				(e.prototype.fetchContextForScope = function (e) {
					var t = this.contextsByScope.get(e);
					return t || ((t = new O(this, e)), this.contextsByScope.set(e, t)), t;
				}),
				e
			);
		})(),
	...
	var B = (function () {
			...
			return (
				...
				(e.prototype.parseValueForToken = function (e) {
					var t = e.element,
						...
						o = r.get(n);
					return o || ((o = new j(this.schema, n, t)), r.set(n, o)), o;
				}),
				(e.prototype.elementMatchedValue = function (e, t) {
		...
		L = (function () {
			function e(e) {
				(this.application = e),
					(this.scopeObserver = new x(this.element, this.schema, this)),
			...
			return (
				...
				(e.prototype.loadDefinition = function (e) {
					...
					var t = new w(this.application, e);
	...
	class V extends S {
		toggle(e) {
			const t = e.target,
				n = this.data.get("hiddenClass"),
				r = "false" !== t.getAttribute("aria-expanded");
			this.navTarget.classList.toggle(n, !r),
	...
	class R extends S {
		...
		toggleLabel() {
			const e = this.data.get("labelHiddenClass");
			this.labelTarget.classList.toggle(e, !!this.inputTarget.value);
		}
	}
	R.targets = ["label", "input"];
	class K extends S {
		constructor() {
			super(...arguments),
				(this.addResult = (e) => {
					const { results: t, resultListTarget: n, createResultLi: r } = this;
					3 === t.length && (t.pop(), n.lastElementChild.remove()),
						t.unshift(e);
					const o = r(e);
					n.insertBefore(o, n.firstElementChild),
						sessionStorage.setItem("shortenedURLResults", JSON.stringify(t));
				}),
				(this.createResultLi = (e) => {
					const t = this.resultTemplateTarget.innerHTML.replace(
							/{{ ([a-zA-Z]+) }}/g,
							(t, n) => "" + e[n]
						),
				...
				(this.setInputValidity = (e) => {
					const { helperTextTarget: t, inputTarget: n } = this,
						r = this.data.get("formErrorClass");
					e
		...
		initialize() {
			var e;
			const t = sessionStorage.getItem("shortenedURLResults");
			this.results = null !== (e = JSON.parse(t)) && void 0 !== e ? e : [];
		}
		connect() {
			const {
				formTarget: e,
			...
			(e.noValidate = !0), t.forEach((e) => r.appendChild(n(e)));
		}
		submit(t) {
			return e(this, void 0, void 0, function* () {
				...
				const {
					...
					s = this.data.get("shortenFailedClass");
				if ((this.element.classList.remove(s), e.checkValidity())) {
					i(!0);
					const e = this.data.get("loadingClass");
					this.element.classList.add(e);
					const t = yield o(n.value);
					this.element.classList.remove(e),
						t.ok ? (r(t), (n.value = "")) : this.element.classList.add(s);
				} else i(!1);
			});
		}
		shorten(e) {
			return fetch(
				"https://api.shrtco.de/v2/shorten?url=" + encodeURIComponent(e)
			)
				.then((e) => e.json())
				.then(
					(t) => {
						...
						return {
							ok: t.ok,
							shortUrl:
								null === (n = t.result) || void 0 === n ? void 0 : n.short_link,
							fullShortUrl:
	...
	K.targets = ["form", "input", "helperText", "resultTemplate", "resultList"];
	class U extends S {
		copy(e) {
	...
	U.targets = ["source"];
	const _ = M.start();
	_.register("navigation", V),
		_.register("form-field", R),
		_.register("url-shortener", K),
		_.register("clipboard", U);
})();
