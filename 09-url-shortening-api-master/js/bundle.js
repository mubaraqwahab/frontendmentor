  ...
  const urlShortenerMachine = createMachine({
      ...
      actions: {
          onInput(_, event) {
              ...
              const urlLabel = (_a = urlInput.form) === null || _a === void 0 ? void 0 : _a.querySelector("[data-label-for='url']");
              // Hide the pseudo-label if the input has a value
              if (urlInput.value) {
                  urlLabel === null || urlLabel === void 0 ? void 0 : urlLabel.classList.add("sr-only");
              }
              else {
                  urlLabel === null || urlLabel === void 0 ? void 0 : urlLabel.classList.remove("sr-only");
              }
          },
          onSubmit(_, event) {
