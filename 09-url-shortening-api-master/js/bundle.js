(function () {
    ...
    ***************************************************************************** */
    ...
    function createURLShortenerMachine(initialResults = []) {
        return s({
            id: "urlShortener",
            initial: "idle",
            context: {
    ...
    class UrlShortenerController extends Controller {
        constructor() {
            ...
            this.addResult = (result) => {
                const { results, resultListTarget, createResultLi, } = this;
                if (results.length === 3) {
                    results.pop();
        ...
        initialize() {
            ...
            const initialResults = (_a = JSON.parse(resultsInStorage)) !== null && _a !== void 0 ? _a : [];
            const urlShortenerMachine = createURLShortenerMachine(initialResults);
            this.service = v(urlShortenerMachine);
        }
        connect() {
            const { formTarget, results, createResultLi, resultListTarget, } = this;
            formTarget.noValidate = true;
            results.forEach((result) => resultListTarget.appendChild(createResultLi(result)));
            this.service.start();
        }
        submit(e) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { formTarget, inputTarget, addResult, shorten, setInputValidity, } = this;
