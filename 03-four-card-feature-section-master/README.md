...
[View my solution](https://mubaraqwahab.github.io/frontendmentor/03-four-card-feature-section-master/).

I learnt how to use [CSS Grid](https://css-tricks.com/snippets/css/complete-guide-grid/) in this challenge, and that CSS variables (or, more formally, custom properties) can be set dynamically.
